...
const Layout = ( { params } )=> 
{
    return (
        ...
        <form class="ui form">
        <div class="field">
            <label>Name of Onsen</label>
            <div class="default text">
                <input type="text" name="shipping[first-name]" placeholder="Name of Onsen" />
            </div>
        </div>
        <div class="field">
            <label>Adress</label>
            <div class="default text">
                <input type="text" name="shipping[first-name]" placeholder="Adress" />
            </div>
        </div>
        <div class="three wide field">
            <label>Minimum Fee</label>
            <input type="text" name="card[cvc]" maxlength="10" placeholder="1000" />
        </div>
        <div class="field">
            <label>Web Site</label>
            <div class="default text">
                <input type="text" name="shipping[first-name]" placeholder="URL" />
            </div>
        </div>
